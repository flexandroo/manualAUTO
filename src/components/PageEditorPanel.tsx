...
export function PageEditorPanel({ page, onChange }: Props) {
  if (!page) {
    return (
      <main className="w-[480px] bg-stone-50 overflow-y-auto p-6 border-r border-stone-100 text-stone-400 text-sm">
  ...
  return (
    <main className="w-[480px] bg-stone-50 overflow-y-auto p-6 border-r border-stone-100">
